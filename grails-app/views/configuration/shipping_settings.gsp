...
<body>
	...
	<h2><g:message code="shipping.settings"/></h2>
	...
	<ul class="nav nav-tabs" style="margin-bottom:30px;">
		...
		<li class="active"><g:link uri="/configuration/shipping_settings" class="btn btn-default"><g:message code="shipping.settings"/></g:link></li>
	</ul>
	...
	<form action="save_shipping_settings" class="form-horizontal" method="post">
		...
		<p class="information secondary"><g:message code="address.information"/></p>
		
		<h4><g:message code="store.address"/></h4>
		
		<div class="form-row">
			<span class="form-label twohundred"><g:message code="address1"/></span>
		...
		<div class="form-row">
			<span class="form-label twohundred"><g:message code="address2"/></span>
			<span class="input-container">
		...
		<div class="form-row">
			<span class="form-label twohundred"><g:message code="city"/></span>
			<span class="input-container">
		...
		<div class="form-row">
		  	<label class="form-label twohundred"><g:message code="country"/></label>
			<span class="input-container">
		...
		<div class="form-row">
			<span class="form-label twohundred"><g:message code="state"/></span>
			<span class="input-container">
				<g:select name="state"
			          from="${State.list()}"
		...
		<div class="form-row">
			<span class="form-label twohundred"><g:message code="zip"/></span>
			<span class="input-container">
		...
		<br/>
		<h4><g:message code="rate.settings"/></h4>
		
		<div class="form-row">
			<span class="form-label twohundred"><g:message code="flat.rate.shipping"/> ${currencyService.getCurrencySymbol()}
				<p class="information secondary"><g:message code="easypost.used"/></p>
			</span>
			<span class="input-container">
		...
		<p class="information secondary"><strong>EasyPost</strong> <g:message code="easypost.description"/> <a href="http://easypost.com" target="_blank">EasyPost Website</a>.</p>
		...
		<div id="easypostSettings">
			<h4><g:message code="easypost.settings"/></h4>
			
			<div class="form-row">
				<span class="form-label twohundred"><g:message code="test.secret.key"/></span>
				<span class="input-container">
