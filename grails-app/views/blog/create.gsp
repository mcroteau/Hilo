...
<html>
	<head>
		...
		<title><g:message code="create.blog.post"/></title>
	...
	<body>
		...
		<div class="form-outer-container">
			...
			<div class="form-container">
				...
				<h2><g:message code="create.blog.post"/>
				...
				<g:form action="save" >
					...
					<div class="buttons-container">
						<g:submitButton name="create" class="btn btn-primary" value="${message(code:'save.blog.post')}" />
					</div>
