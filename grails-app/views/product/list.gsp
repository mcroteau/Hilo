		...
		<div id="list-product" class="content scaffold-list" role="main">
			...
			<div style="float:right; width:570px; ">
				...
				<g:form action="admin_search" class="form-horizontal">
					...
					<input type="text" name="query" value="${query}" id="searchbox" class="form-control" style="width:250px;height:37px !important;" placeholder="${message(code:'search.by.name')}"/>
				</g:form>
			</div>
