...
<html>
	<head>
		...
		<title><g:message code="order.catalogs"/></title>
	...
	<body>
		...
		<div class="content">
			...
			<h2><g:message code="order.catalogs"/>

				<g:link controller="catalog" action="list" class="btn btn-default pull-right" ><g:message code="back.to.list.view"/></g:link>
			...
			<g:if test="${catalogs}">
				<p class="information secondary"><g:message code="click.drag.catalog.message"/></p>
