...
<head>
	...
	<title><g:message code="create.customer"/></title>	
</head>
...
<body>
	...
	<div class="form-outer-container">
		...
		<div class="form-container">
			...
			<h2><g:message code="create.account"/>					
			...
			<g:form action="admin_save" class="form-horizontal" role="form" method="post">
				...
				<div class="form-row">
					<span class="form-label full"><g:message code="password"/></span>
					<span class="input-container">
				...
				<div class="form-row">
					...
					<span class="input-container">
						...
						<span class="information"><g:message code="all.accounts.message"/></span>		</span>
					<br class="clear"/>
				</div>	
				
				
				<div class="buttons-container">	
					<g:submitButton name="create" class="btn btn-primary" value="${message(code:'create.account')}" />		
				</div>
