...
html,
	...
	<div id="login-container">
		...
		<a href="http://www.goioc.xyz" target="_blank" title="IOC"><img src="${resource(dir:'images/app/hilo-icon.png')}" style="height:inherit;width:inherit;outline:none;position:absolute;top:0px;right:70px;"/></a>
