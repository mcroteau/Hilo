				...
				<div class="form-row">
					...
					<span class="input-container">
						<span class="information">
							...
							<a href="/${applicationService.getContextName()}/page/store_view/${URLEncoder.encode("${pageInstance.title}", "UTF-8")}" target="_blank"><g:message code="test"/></a>
						</span>
					</span>
					<br class="clear"/>
				</div>
