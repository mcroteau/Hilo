...
import io.hilo.DevelopmentData
...
class DevelopmentController {
	...
	def generate_development_data(){
		...
		flash.message = messageSource.getMessage("successfully.generated.development.data", null, LocaleContextHolder.locale)
	...
	def generate_customers(){
		createCustomers()
		flash.message = messageSource.getMessage("successfully.generated.customers", null, LocaleContextHolder.locale)
		redirect(controller:'configuration', action:'index')
	}
