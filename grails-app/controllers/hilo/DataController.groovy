...
public class DataController {
	...
	def accounts(){
		...
		if(!key){
			render messageSource.getMessage("provide.private.key", null, LocaleContextHolder.locale)
			return
		}
		...
		if(key != privateKey){
			render messageSource.getMessage("key.does.not.match", null, LocaleContextHolder.locale)
			return
		}
